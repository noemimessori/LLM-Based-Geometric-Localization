...
class Visualization:
    ...
    def draw(self, world):
        ...
        self.draw_text("Mathematical Prompt", (40, 40), self.BLACK)
        ...
        for i, (name, coords) in enumerate(self.shadow_robots.items()):
            if i <= self.robot_index:  # Draw robots up to the current index
    ...
    def handle_click(self, pos, world):
        shadow_data = [
            {
                "Gemini": (-3, 0, 0), "Claude": (-3, 0, 0), "GPT": (-3, 0, 0), "Llama": (-3.23, 0, 59.8)
            },
            {
                "Gemini": (-3.4, 0, 0), "Claude": (-3.403, 0, 90), "GPT": (-4, 0.5, -90), "Llama": (-3.54, 8.834, -145.8)
            },
            {
                "Gemini": (0.1, -3.8, 2), "Claude": (-0.06, -3.75, 90), "GPT": (-0.06, -3.75, -87.5), "Llama": (-3, 5, 0)
            },
            {
                "Gemini": (2.5, -1.5, -20), "Claude": (2.961, -2.332, 135), "GPT": (3, -2.4, 155), "Llama": (0.06, -6.18, 10.4)
            },
            {
                "Gemini": (2, -2.5, -45), "Claude": (2.042, 1.882, 90), "GPT": (2.42, -2.43, 100), "Llama": (2.31, 1.42, -54.3)
            },
            {
                "Gemini": (-4, 0, 180), "Claude": (-4.02, -2.33, -151.8), "GPT": (-4.25, -1.85, 180), "Llama": (0, 0, 0)
            }
        ]
