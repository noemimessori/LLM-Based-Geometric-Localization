...
class Visualization:
    ...
    def draw(self, world):
        ...
        self.draw_text("Standard Prompt", (40, 40), self.BLACK)
        ...
        for i, beacon in enumerate(world.beacons):
            ...
            if i in self.visible_beacons[
                ...
                for j, line in enumerate(detailed_label):
                    offset_y = 10 + j * 15  # Spaziatura verticale tra le righe
    ...
    def handle_click(self, pos, world):
        shadow_data = [
            {
                "Gemini": (-3, 0, 0), "Claude": (-3, 0, 0), "GPT": (-3, 0, 0), "Llama": (-3, 0, 0)
            },
            {
                "Gemini": (-4.1, 0.9, 50), "Claude": (-3.4, 0, -90), "GPT": (-4, -1, 0), "Llama": (-3, 0, -45)
            },
            {
                "Gemini": (0, -5, -90), "Claude": (0.05, -3.74, 2.5), "GPT": (0, -3.74, 90), "Llama": (-3, 0, 0)
            },
            {
                "Gemini": (2.1, -3.3, 155), "Claude": (3, -2.5, 120), "GPT": (2, -3.74, -155), "Llama": (-3, 0, 0)
            },
            {
                "Gemini": (1, 2, 60), "Claude": (2, 2, 45), "GPT": (1.5, 2.5, -90), "Llama": (0, -2.23, 92.6)
            },
            {
                "Gemini": (-4.5, -1, 180), "Claude": (-3.5, -2, -45), "GPT": (3, -2.5, 120), "Llama": (-4.5, 3.5, -118.4)
            }
        ]
